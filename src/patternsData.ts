...
void main() {
    ...
    for (float i = 0.0; i < 80.0; i++) {
        ...
        // Dynamic color mixing based on depth and position
...
`
  ...
  {
    id: "lumen-holo-dice-original",
    name: "Holo Foil Dice (Original)",
    category: "Lumen Borrowed",
    description: "Iridescent holographic foil TTRPG dice simulation, featuring 3D wireframe raymarched faces (original rainbow version).",
    thumbnailUrl: "/thumbnails/lumen-holo-dice.png",
    previewSnapshotUrl: "/thumbnails/lumen-holo-dice.png",
    renderEngine: "webgl2",
    tags: ["animated", "raymarch", "holo", "dice", "original"],
    useCases: ["Background visuals", "Holographic cards"],
    defaultPalette: {
      id: "p21-orig",
      name: "Iridescent (Fixed)",
      stops: [
        { id: "s1", color: "#f8f9fa", position: 0.0 },
        { id: "s2", color: "#ff66cc", position: 0.25 },
        { id: "s3", color: "#66ccff", position: 0.5 },
